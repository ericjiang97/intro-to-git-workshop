...
# A big thanks to our swag/resource sponsor - GitHub
...
1. Go to [https://github.com](https://github.com) to create an account if you don't have one (use your student email address as the primary email)
2. Go to [https://lab.github.com](https://lab.github.com) and sign up to GitHub Learning Lab
3. We're going to do the _Introduction to GitHub_ course

---

![inline](https://cdn-std.dprcdn.net/files/acc_609987/dbpfUj)
...
## Go to [kahoot.it](kahoot.it) and enter the code 732600
...
Make sure to check out the GitHub Education Pack at [https://education.github.com/pack](https://education.github.com/pack), which includes:
...
- LinkedIn [@ericjiang97](https://linkedin.com/in/ericjiang97)
